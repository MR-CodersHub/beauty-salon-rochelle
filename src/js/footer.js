      ...
      <footer class="bg-[#100C0D] text-gray-400 pt-16 pb-12 border-t border-zinc-800 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-14">
            ...
            <!-- Col 2: Services -->
            <div>
              <h4 class="text-white text-xs font-bold uppercase tracking-widest mb-4">Doorstep Services</h4>
            ...
            <!-- Col 3: Company -->
            <div>
              <h4 class="text-white text-xs font-bold uppercase tracking-widest mb-4">Company & Info</h4>
              <ul class="space-y-2.5 text-xs">
                <li><a href="${root}public/pages/about.html" class="hover:text-[#BD5579] transition">About Our Story</a></li>
                <li><a href="${root}public/pages/pricing.html" class="hover:text-[#BD5579] transition">Pricing & Bundles</a></li>
                <li><a href="${root}public/pages/blog.html" class="hover:text-[#BD5579] transition">Beauty Journal (Blog)</a></li>
                <li><a href="${root}public/pages/FAQ.html" class="hover:text-[#BD5579] transition">Frequently Asked</a></li>
                <li><a href="${root}public/pages/contact.html" class="hover:text-[#BD5579] transition">Contact Concierge</a></li>
                <li><a href="${root}public/pages/404.html" class="hover:text-[#BD5579] transition">404 Error Page</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p class="text-[10px] text-gray-500 mt-2">🔒 256-bit encrypted. Unsubscribe anytime.</p>
            </div>
          </div>
          ...
          <div class="pt-8 border-t border-zinc-800/80 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs">
            ...
            <div class="flex items-center gap-6">
              ...
              <a href="${root}public/pages/FAQ.html" class="hover:text-white transition">Safety Protocol</a>
            </div>
          </div>
        </div>
      </footer>
